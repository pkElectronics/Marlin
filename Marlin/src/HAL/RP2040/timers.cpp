...
volatile bool HAL_timer_irq_en[4] = {0,0,0,0};
...
void HAL_timer_start(const uint8_t timer_num, const uint32_t frequency) {
  ...
  switch (timer_num){
    ...
    case 0:
      returnvalue = alarm_pool_add_repeating_timer_us(HAL_timer_pool_0,us,HAL_timer_repeating_0_callback, NULL, &HAL_timer_0);
      break;

    case 1:
      returnvalue = alarm_pool_add_repeating_timer_us(HAL_timer_pool_1,us,HAL_timer_repeating_1_callback, NULL, &HAL_timer_1);
      break;

    case 2:
      returnvalue = alarm_pool_add_repeating_timer_us(HAL_timer_pool_2,us,HAL_timer_repeating_2_callback, NULL, &HAL_timer_2);
      break;

    case 3:
      returnvalue = alarm_pool_add_repeating_timer_us(HAL_timer_pool_3,us,HAL_timer_repeating_3_callback, NULL, &HAL_timer_3);
      break;
  }
}
...
void HAL_timer_stop(const uint8_t timer_num) {
   switch (timer_num){
    ...
    case 1:
      cancel_repeating_timer(&HAL_timer_1);
      break;

    case 2:
      cancel_repeating_timer(&HAL_timer_2);
      break;

    case 3:
      cancel_repeating_timer(&HAL_timer_3);
      break;
  }
}
